...
export function ScanCheckinPage() {
  ...
  const handleScan = async (results: { rawValue?: string }[]) => {
    ...
    try {
      ...
      console.log("[ScanCheckin][transit] lookup product:", {
      ...
      console.log("[ScanCheckin][transit] signer/auth addresses:", {
        custodianAddress,
        ownerIdentity,
      });
      console.log("[ScanCheckin][transit] owners order used for policyId:", {
        baseOwners,
        currentOwners,
      });
