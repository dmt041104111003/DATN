...
const menuItems = [
  ...
  { title: "Suppliers", href: "/dashboard/suppliers", icon: "local_shipping" },
  { title: "Warehouses", href: "/dashboard/warehouses", icon: "warehouse" },
  { title: "Processes", href: "/dashboard/processes", icon: "settings" },
  { title: "Certifications", href: "/dashboard/certifications", icon: "verified" },
  { title: "Media", href: "/dashboard/media/files", icon: "image" },
  { title: "Billing", href: "/dashboard/billing/services", icon: "payments" },
] as const
