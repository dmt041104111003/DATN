...
export const CONTACT_INFO_LABELS: Record<Language, { address: string; phone: string; fax: string; hotline: string }> = {
  ...
  vi: { address: 'Địa chỉ', phone: 'Điện thoại', fax: 'Fax', hotline: 'Đường dây nóng' },
  zh: { address: '地址', phone: '电话', fax: '传真', hotline: '热线' },
  fr: { address: 'Adresse', phone: 'Téléphone', fax: 'Fax', hotline: 'Hotline' },
};
