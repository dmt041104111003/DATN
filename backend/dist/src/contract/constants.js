...
exports.title = exports.EXCHANGE_FEE_PRICE = exports.appNetworkId = exports.appNetwork = exports.APP_MNEMONIC = exports.APP_WALLET_ADDRESS = exports.BLOCKFROST_API_KEY = void 0;
exports.BLOCKFROST_API_KEY = process.env.BLOCKFROST_API_KEY || '';
exports.APP_WALLET_ADDRESS = process.env.APP_WALLET_ADDRESS || '';
exports.APP_MNEMONIC = process.env.APP_MNEMONIC || '';
