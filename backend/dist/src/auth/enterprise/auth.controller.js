...
let AuthController = class AuthController {
    enterpriseAuth;
    authService;
    constructor(enterpriseAuth, authService) {
    ...
    async verifyWallet(dto, res) {
        const result = await this.enterpriseAuth.verifyWallet(dto.address, dto.signature, dto.key, dto.walletName);
...
exports.AuthController = AuthController = __decorate([
    (0, common_1.Controller)('enterprise/auth'),
