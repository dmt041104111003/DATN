...
let AgentAuthController = class AgentAuthController {
    ...
    getAgentNonce(dto) {
        return this.authService.getAgentNonce(dto.address);
    }
    async verifyAgentWallet(dto, res) {
        const result = await this.authService.verifyAgentWallet(dto.address, dto.signature, dto.key, dto.walletName);
...
], AgentAuthController.prototype, "getAgentNonce", null);
__decorate([
    (0, decorators_1.Public)(),
...
], AgentAuthController.prototype, "verifyAgentWallet", null);
